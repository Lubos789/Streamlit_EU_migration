...
#######################
# Load data
df_reshaped = pd.read_csv('data/eu-migration-2013-2022-reshaped.csv')

#######################
# Sidebar
with st.sidebar:
    st.title('Europe Migration Dashboard')
